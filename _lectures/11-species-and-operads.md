...
An operad is a monoid for the substitution product discussed in [lecture 3](./03-monoidal-structures-on-P.html#defi-5). As such, "the theory of operads" is the study of the category $\mathbf{Opd}={\bf Mon}({\bf Spc},\circ)$; but things are never as simple as they seem...
...
**Example.** Every species $P$ defines an operad, the *endomorphism operad*, with carrier $\\{P,P\\}$ (notation as in [the construction of the internal hom for $\circ$](./03-monoidal-structures-on-P.html#dayhom)); the unit is the mate of the left unitor $y(1)\circ P \to P$, and the multiplication is obtained as the mate of the counit of $-\circ P\dashv \\{P,-\\}$:
...
is a bracketing of $3+5+2+4=14$ symbols (a certain care is needed to make this precise, much like it's needed some care in making precise the substitution of a $\lambda$-term inside another...)
