{
  ...
  antex = {
    dependencies = ["liquid" "nokogiri"];
    groups = ["default" "jekyll_plugins"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1vaw67m23kc12gl7p2cggswc17nbvgd9si109ddpg12jps89adc5";
      type = "gem";
    };
    version = "0.2.0";
  };
  ...
  jekyll-antex = {
    dependencies = ["antex" "jekyll" "kramdown-parser-gfm" "nokogiri"];
    groups = ["jekyll_plugins"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "06vlgafrk0z1mk7p8zk4919azx58y921nnjav88ccnnhyrkvh62n";
      type = "gem";
    };
    version = "0.9.0";
  };
